...
// Function to generate random numbers from a given distribution
...
// Function to compress floating-point numbers by zeroing out the least significant bits
...
// Function to compress a vector of floating points
...
int main() {
    size_t n = 1e6; // 1 million samples
    ...
    // Apply lossy compression (zero out 10 least significant bits)
    int bits_to_zero = 10;
    ...
    // Compute statistics before and after compression
    ...
    // Measure file sizes and calculate storage savings
