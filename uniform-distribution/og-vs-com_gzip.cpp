...
//To Save float vector to a binary file
...
//To Compress using gzip and get compressed size
...
int main() {
    ...
    //To Measure file sizes before compression
    ...
    //To Compress files using gzip and get compressed sizes
